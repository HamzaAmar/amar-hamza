...
<Conversation.Thread from="user">
  Hey Chat, I've been hearing a lot about Server Components in web
  development lately. Can you explain what they are and why they're
  beneficial?
</Conversation.Thread>
...
<Conversation.Thread from="narrator">
  <div>
    ...
    are like a burger – ready to eat right away (server component).
    Others are like a steak – they need a little extra something, like
...
<Conversation.Thread from="server">
  ...
  <div>
    **Improved User experience:** Since server components don’t
...
<Conversation.Thread from="server">
  ...
  <div>
    ...
    Enhancement.](/blogs/static-site-speed-and-security-unleashed#static-site-enhancement)
  </div>
  <div>
    For the issue of slow loading page sections due to database calls
    or other processes, we can leverage
    [Streaming](/blogs/streaming-server-side-rendering-efficient-content-delivery)
    to ensure that the rest of your page content is displayed promptly
    without being held back by slower components.
  </div>
</Conversation.Thread>
