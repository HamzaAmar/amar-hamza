...
<div>Imagine a traditional Moroccan wedding feast where up to four different courses are served. If all the dishes were prepared at once, it would create a lot of stress for the chefs and could delay the feast.</div>
