...
<Conversation.Thread from="browser">
  ...
  <div>
    Lazy Loading: Load images and media only when they come into view.
    😴
  </div>
  <div>
  ...
  <Conversation.Thread from="user">
    That makes sense! How would I go about building a static website?
    🏗️
  </Conversation.Thread>
  <Conversation.Thread from="server">
   <div> You have a few options:  </div> <div> Use HTML, CSS, and
    JavaScript. 💪 </div>      <div> Use a Framework Tools like 11ty, Hugo, or Jekyll
    can make it easier. 🧰</div>
  </Conversation.Thread>
  <Conversation.Thread from="user">
  ...
  <Conversation.Thread from="server">
    You're welcome! Static sites are a great option for many, but if
    you need more interactivity, stay tuned for our next chat about
