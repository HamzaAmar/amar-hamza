...
<Conversation>
  ...
  <Conversation.Thread from="user">
    That's interesting! But why would someone choose a static website
    over other types? 🤷‍♀️
  </Conversation.Thread>
  <Conversation.Thread from="server">
    <div>
...
<Conversation.Thread from="browser">
  ...
  <div>
    **Optimize Images**: Compress them without sacrificing quality. 🖼️
  </div>
  <div>
    **Minify Code**: Remove unnecessary characters and whitespace. 🧹
  </div>
  <div>
    **Lazy Loading**: Load images and media only when they come into
    view. 😴
  </div>
  <div>
