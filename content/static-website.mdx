...
<Conversation>
  ...
  <Conversation.Thread from="narrator">
    Think of a **static website** like a food truck parked on a busy street. 🚚 The menu is fixed, and all the dishes are prepared in advance. You walk up, look at the options displayed on the side of the truck, and pick what you want. It's fast, convenient, and exactly what you see is what you get.
  </Conversation.Thread>
    <Conversation.Thread from="user">
    Mmm, that sounds tasty! But how does that relate to websites?
  </Conversation.Thread>
  ...
  <Conversation.Thread from="server">
    ...
    <div> You prioritize lightning-fast loading times. 🚀 </div>
  ...
  <Conversation.Thread from="server">
      ...
      <div> 
          Wallet-Friendly: Hosting costs are lower due to
          reduced processing power requirements. 💵 
      </div>
      <div>
          SEO friendly: Search
          engines love static websites because of their simple structure and
          fast loading times. 🏆
      </div>
...
<Conversation.Thread from="server">
  ...
  <div>
    Content Updates: Changing content, whether adding or removing,
    requires editing the code and redeploying the entire website. 🛠️
  </div>
</Conversation.Thread>
<Conversation.Thread from="user">
  I'm really liking this static website concept! I'm curious, though,
  are there any potential performance issues I should be aware of?
</Conversation.Thread>
<Conversation.Thread from="browser">
  You got it! Large files can slow me down. 🐌 I need to process all
...
<Conversation.Thread from="browser">
  <div>
    Absolutely, large files can slow things down. But don't worry,
  ...
  <div>
    **Optimize Images** 🖼️: Compress, [Use Modern Formats (like WebP, AVIF)](https://www.smashingmagazine.com/2021/09/modern-image-formats-avif-webp/), [Lazy Loading](https://web.dev/articles/browser-level-image-lazy-loading) , Responsive Sizing
  </div>
  <div>
...
<Conversation.Thread from="server">
  <div> You have a few options: </div>
  <div> Use HTML, CSS, and JavaScript. 💪 </div>
  <div>
    Use a Framework Tools like 11ty, Hugo, or Jekyll can make it easier.🧰
  </div>
</Conversation.Thread>
<Conversation.Thread from="user">
...
<Conversation.Thread from="server">
  ...
  need more interactivity, stay tuned for our next chat about Multi
