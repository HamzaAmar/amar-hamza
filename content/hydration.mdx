...
<Conversation>
  ...
  <Conversation.Thread from="browser">
    ...
    [Island
    architecture](/blogs/http://localhost:3000/blogs/island-architecture-enhancing-performance-and-interactivity)
    | [Server
    Components](/blogs/react-server-components-server-side-react-for-better-performance)
    , and more. Stay tuned!
  </Conversation.Thread>
  <Conversation.Thread from="user">
