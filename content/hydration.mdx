...
<Conversation>
  ...
  <Conversation.Thread from="server">
    ...
    two phases: rendering on the server, which delivers initial
    content quickly, and client side hydration, which makes the
    rendered content interactive. this means that hydration is part of
  ...
  <Conversation.Thread from="me">
    ...
    follow me and let chat X [My X](https://x.com/HamzaMiloudAma1) to
