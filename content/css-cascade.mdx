...
image:
  src: "/assets/blog/cascade/css-cascade-specificity-performance.webp"
  alt: "CSS cascade illustration for specificity, inheritance, and performance in styling"
publishedAt: "2024-09-02T05:35:07.322Z"
lastModified: "2024-09-02T05:35:07.322Z"
author:
  name: Hamza Miloud Amar
  picture: "/me.jpg"
tags: ["CSS Cascade", "CSS Specificity", "Web Performance", "CSS Architecture", "Frontend", "Styling"]
---
...
/>
In this example, we aim to highlight all potential scenarios of a conflict, including those with normal declarations,
with important declarations, and those with both. But before going through the conflict, let's begin by identifying
styles that don't have any conflicts; they will be apply directly without the need for cascade resolution.
...
customElements.define(
  ...
  class extends HTMLElement {
    connectedCallback() {
      this.attachShadow({ mode: "open" }).append(button.content.cloneNode(true));
    }
  },
);
```
