...
<Conversation>
  ...
  <Conversation.Thread from="browser">
    <div>
      ...
      details.](/hydration-combining-server-and-client-rendering)
    </div>
  </Conversation.Thread>
  <Conversation.Thread from="user">
