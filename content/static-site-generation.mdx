...
<Conversation>
  <Conversation.Thread from="user">Hey Chat, could you explain SSG with Hydration in simple terms, assuming I have no idea about **rendering patterns**? 🤔</Conversation.Thread>
...
<Conversation.Thread from="browser">
  <div>
    Absolutely! There are several ways to optimize those files. We've
