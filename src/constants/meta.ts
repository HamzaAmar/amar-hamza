const meta = {
  ...
  siteUrl: process.env.ROOT_URL || "https://laughing-lichterman-b8386d.netlify.app", // Domain of your site. No trailing slash!
  ...
  tags: ["React", "Next", "Gatsby", "CSS", "HTML", "Performance", "Accessibility", "Javascript"],
};
