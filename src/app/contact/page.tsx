		...
		<Grid columns="1fr 1fr" className="sm_grid-one p-co">
			<div className="p-co-info Sf-5">
				...
				<Text color="b" size="6" low>
					I'm a<strong> freelance web developer</strong> passionate about
					crafting exceptional digital experiences. If you're looking for a{" "}
					<strong>skilled developer</strong> to bring your website or
					application to life, please complete the form below. I'd love to
