		...
		<div>
			<Flex items="center" justify="between" className="blogs--hero sct" wrap>
				<div className=" Sf-6" style={{ maxWidth: "80ch" }}>
					...
					<Text>
						Dive into our <strong> frontend development</strong> articles and
						unlock the secrets to building modern, interactive websites. From
						HTML, CSS, and JavaScript fundamentals to advanced frameworks like
						React, our in-depth guides and blog series will help you master the
						latest web technologies and create exceptional user experiences
					</Text>
				</div>
				<Image
