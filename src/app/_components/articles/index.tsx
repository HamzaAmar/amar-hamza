...
import { Grid, HeroHeading } from "@components/core";
...
const articles = ({ posts, description }: ArticlesProps) => {
	return (
		<section aria-labelledby="articles-id-section" className="sct Sf-6">
			<HeroHeading
			...
			/>
			<Grid columns="1fr 1fr 1fr" gap="5" className="sm_grid-one md_grid-two">
				{posts.map((post) => (
