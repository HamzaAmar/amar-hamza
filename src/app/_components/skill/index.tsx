import { CircleProgress, Flex, Grid, HeroHeading, Text } from "@components/core";
import React from "react";

import SKILLS from "./skills.data";
import type { ItemSkillProps } from "./skills.type";

const Item = ({ title, icon, level, description }: ItemSkillProps) => {
  const iconUI = icon ? (
    <div className="sk-C">
  ...
  return (
    <Flex as="li" gap="4" className="sk- l_box-article shows-scroll" key={title}>
      <div className="sk-A">
...
const SkillsContainer = () => {
  return (
    <section aria-labelledby="skills-id-section" className="section Sf-6">
      <HeroHeading
