		...
		<Grid columns="1fr 260px" className="re- sm_grid-one">
			<div>
				<div className="re-H Sf-4">
					...
					<Text color="b" low>
						Expert Frontend Developer with a decade of experience in building
						enterprise-scale design systems and accessible web applications.
						Architecting large-scale projects with Next.js, optimizing web
						performance, and ensuring WCAG compliance across diverse user needs.
						Proven leader in scaling frontend architecture and implementing
						inclusive design practices, resulting in an 80% reduction in
						production issues while maintaining AA/AAA accessibility standards.
					</Text>
				</div>
