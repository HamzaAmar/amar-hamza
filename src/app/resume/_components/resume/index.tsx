    ...
    <Grid columns="1fr 260px" className="re- sm_grid-one">
      <div>
        <div className="re-H Sf-4">
          <Flex gap="4" items="center">
            <div>
              <Avatar image="/me.jpg" size="5" title="Hamza miloud amar" />
            </div>
            <div>
              <Text type="heading" as="h1" weight="5" align="start" size="6">
                Hamza Miloud Amar
              </Text>
              <Text color="p" low weight="1" align="start" size="4" as="h2">
                Expert React Developer & CSS Enthusiast
              </Text>
            </div>
          </Flex>
          <Text color="b" low>
            Expert Frontend Developer with a decade of experience in building enterprise-scale design systems and
            accessible web applications. Architecting large-scale projects with Next.js, optimizing web performance, and
            ensuring WCAG compliance across diverse user needs. Proven leader in scaling frontend architecture and
            implementing inclusive design practices, resulting in an 80% reduction in production issues while
            maintaining AA/AAA accessibility standards.
          </Text>
        </div>
