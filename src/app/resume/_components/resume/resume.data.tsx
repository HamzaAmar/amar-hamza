import { Arabic, Call, English, French, Github, Globe, Linkdin, Pen } from "@components/icons";
...
export const SKILLS: [string, string[]][] = [
  ...
  ["Methodologies", ["Agile / Scrum", "TDD", "Atomic Design", "CUBE CSS", "BEM", "ITCSS", "Pillar CSS"]],
  [
    "Scaling",
    [
      "Core Web Vitals",
  ...
  ["Leadership & Collaboration", ["Cross-functional Team leadership", "Technical mentorship", "Code Review"]],
  [
    "Architecture",
    [
      "Design systems",
...
export const Interests = ["Video Editing", "Open Source Contributions", "History Enthusiast", "Technical Writing"];
...
export const BOOKS = [
  ...
  {
    key: "7",
    title: "J. David Eisenberg, Amelia Bellamy-Royds - SVG Essentials",
  },
